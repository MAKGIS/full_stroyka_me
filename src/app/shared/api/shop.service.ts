...
export class ShopService {
    ...
    getCategoriesList(): Observable<Category[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'fake-server':
                // mak ???
                const categories = getCategoriesTree_('shop',  null, 1);
    ...
    getCategory(slug: string): Observable<Category> {
        ...
        if (this.isLog)  {console.log('- srv -- ShopService.getCategory() slug -> %o', slug)}
        ...
        switch (getModeSource()) {
            ...
            case 'json':
                ...
                .pipe(
                    tap( n=>
                        {
                        if (this.isLog)  {console.log('- srv -- ShopService.getCategory()  this.delayTest -> %o', this.delayTest)}
                    }),
                    delay(this.delayTest)
                );
                break;
    ...
    getCategories(categoriesService: CategoriesService, parent: Partial<Category> = null, depth: number = 0): Observable<Category[]> {
        ...
        if (this.isLog)  {
            ...
            console.log('- srv -- ShopService.getCategories() mode -> %o', getModeSource());
        }
        ...
        switch (getModeSource()) {
            ...
            case 'fake-server':
                 // mak ???
                 const categories = getCategoriesTree_('shop', parent ? parent.slug : null, depth);
                 this.categoriesService.next(categories);
                    ...
                    tap( categories =>
                        {
                            // mak ???
                            this.categoriesService.next(categories);
                            if (this.isLog)  {console.log('- srv -- ShopService  this.delayTest -> %o', this.delayTest)}
                    }),
                    delay(this.delayTest)
                );
                break;
    ...
    getCategoriesBySlug(categoriesService: CategoriesService, slugs: string[], depth: number = 0): Observable<Category[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'fake-server':
                const  categories = getShopCategoriesBySlugs(slugs, depth);
                    ...
                    return this.pimalionCloudService.getProductsList(body, this.categoriesService, this.brandsService)
                        .pipe(
                            switchMap(pimalionBody => {
                                ...
                                const productsList = getProductsListPimalion(this.categoriesService, this.brandsService, categorySlug, options, pimalionBody);
    ...
    getTopRated(limit: number = null): Observable<Product[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getTopRated() ')}
    ...
    getSpecialOffers(limit: number = null): Observable<Product[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getSpecialOffers()')}
    ...
    getFeaturedProducts(categorySlug: string = null, limit: number = null): Observable<Product[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getFeaturedProducts()')}
    ...
    getLatestProducts(categorySlug: string = null, limit: number = null): Observable<Product[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getLatestProducts() ')}
    ...
    getRelatedProducts(product: Partial<Product>): Observable<Product[]> {
        ...
        switch (getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getRelatedProducts()')}
    ...
    getSuggestions(query: string, limit: number, categorySlug: string = null, filterOption: IFilterOption ): Observable<Product[]> {
        ...
        if (this.isLog)  {console.log('- srv -- ShopService.getSuggestions() filterOption ->%o', filterOption)}
...
*/
                ...
                if (this.isLog)  {console.log('- srv -- ShopService.getSuggestions() options ->%o', options)}
    ...
    getRateValues(baseCode: string): Observable<RateValue> {
        /**
         * This is what your API endpoint might look like:
         *
         * https://example.com/api/shop/categories/power-tools.json
        ...
        if (this.isLog)  {console.log('- srv -- ShopService.getRateValues() baseCode -> %o', baseCode)}
