...
*/
  ...
  getProductsList(body: any, categoriesService: CategoriesService, brandsService: BrandsService): Observable<any> {
...
/*
  ...
  */
    ...
    getRateValues(baseCode: string): Observable<any> {
        ...
        return this.http.get<RateValue>( url,  {
            headers: new HttpHeaders()
             // .set('Content-Type', 'application/json')
              .set('Accept', '*/*')
        // , responseType: 'json'
