...
@Component({
    selector: 'app-product-tabs-belgium',
    templateUrl: './product-tabs-belgium.component.html',
    styleUrls: ['./product-tabs-belgium.component.scss']
})
export class ProductTabsBelgiumComponent {
    @Input() withSidebar = false;
    @Input() tab: 'description'|'specification'|'reviews'|'documents'|'price' = 'description';
    @Input() product: Product;


    tagLang = 'prod-tabs-belgium.';

    specification: ProductFeaturesSection[] = specification;
    reviews: Review[] = reviews;
    generateTitleText = "Generate content"; // G�n�rer les contenus";
    generateAttributesText = "Generate content"; // Generer les contenus";
    ...
    getTitre() {
        ...
        this.pimalionCloudService.getProductDetailPage_01(this.product.id + '')
          .subscribe({
            next:(data: any) => {
                this.product = new ProductItem(data);this.generateTitleText = "Generer les contenus"
